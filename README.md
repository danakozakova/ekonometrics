...
Nasledujúce tri úlohy sú tímová práca autorov **P.-J. N., V. K., A. B.** a **Dana Kozáková**, zverejnená so súhlasom všetkých. Pri každej je uvedený môj podiel.
...
Mgr. Dana Kozáková — matematika, štatistika, dáta, AI. Viac na mojom [GitHub profile](https://github.com/danakozakova)·
